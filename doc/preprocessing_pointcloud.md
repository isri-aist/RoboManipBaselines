...
$ uv run python ./misc/VisualizePointCloud.py ./dataset/<dataset_name>/<rmb_file_name>
```
...
# Go to the top directory of this repository
$ cd robo_manip_baselines
$ uv run python ./misc/AddPointCloudToRmbData.py ./dataset/<dataset_name> --min_bound <x, y, z> --max_bound <x, y, z> --rpy_angle <roll, pitch, yaw>
```
