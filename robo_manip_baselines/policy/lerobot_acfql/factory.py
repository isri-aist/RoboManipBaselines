...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        from robo_manip_baselines.policy.lerobot_acfql.acfql_policies.modeling_acfql import ACFQLPolicy
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    if isinstance(policy_cfg, TDMPCConfig):
        ...
        from robo_manip_baselines.policy.lerobot_acfql.acfql_policies.processor_acfql import make_acfql_pre_post_processors
