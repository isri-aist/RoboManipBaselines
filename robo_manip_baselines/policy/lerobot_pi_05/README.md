...
PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True python /home/dev/RoboManipBaselines/third_party/lerobot/src/lerobot/scripts/lerobot_train.py \
    --policy.type=pi05 \
    --dataset.repo_id=/home/dev/dataset_baseline/lerobot/MujocoUR5eSimplePick/ \
    --output_dir=/home/dev/checkpoint_baseline/lerobot_pi05/MujocoUR5eSimplePick/ \
...
PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True python /home/dev/RoboManipBaselines/third_party/lerobot/src/lerobot/scripts/lerobot_train.py     --policy.type=pi05     --dataset.repo_id=/home/dev/dataset_baseline/lerobot/MujocoUR5eSimplePick/     --output_dir=/home/dev/checkpoint_baseline/lerobot_pi05/MujocoUR5eSimplePick/     --job_name=MujocoUR5eSimplePick     --policy.device=cuda     --wandb.enable=false     --policy.push_to_hub=false     --batch_size 2     --save_freq=5000     --policy.compile_model=true     --policy.gradient_checkpointing=true --policy.pretrained_path=lerobot/pi05_base
