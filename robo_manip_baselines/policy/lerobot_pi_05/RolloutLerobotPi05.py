...
from lerobot.policies.pi0.configuration_pi05 import PI05Config
...
class RolloutLerobotPi0(RolloutLerobotBase, TeleopRolloutBase):
    """
    A refined rollout script for the lerobot Pi05 policy, inheriting common
    ...
    def setup_policy(self):
        ...
        self.policy_cfg = PI05Config(**config_dict)
